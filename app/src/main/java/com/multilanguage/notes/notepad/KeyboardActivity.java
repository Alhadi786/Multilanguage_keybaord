...
public class KeyboardActivity extends Activity implements
	...
	protected void onResume() {
		super.onResume();
		Log.i("KeyboardActivity", "onResume: ");
	}



	Bundle bundle;
String recevied_memo_txt;
...
String language=" ";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		memoDbClass=new MemoDbClass(KeyboardActivity.this);
		...
		preferences = PreferenceManager
				.getDefaultSharedPreferences(KeyboardActivity.this);

		bundle=getIntent().getExtras();
if(bundle!=null) {
	recevied_memo_txt = bundle.getString("memo");
}
	...
	public class LongOperation extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressDialog = ProgressDialog.show(KeyboardActivity.this,
	...
	private void init() {
		...
		setKeys();
			...
			public void onClick(View arg0) {
				if(bundle==null){
					Log.i("Keyboard", "onClick: ");
					Calendar calendar = Calendar.getInstance();
					SimpleDateFormat mdformat = new SimpleDateFormat("dd/MM/yyyy ");
					String strDate = mdformat.format(calendar.getTime());
					memoText =mEt.getText().toString();
					String timeFormate="hh:mm aaa";
					String time= (String) DateFormat.format(timeFormate,Calendar.getInstance().getTime());
					memoDbClass.InsertMemo(memoText,strDate,time,language);
					MainActivity.getAllmemos();
					finish();
				}
				else{

					int memo_id =bundle.getInt("id");

					memoText =mEt.getText().toString();
					memoDbClass.updateMemo(memo_id-1,memoText);
					Log.i("Keyboard", "id: "+memo_id+"txt "+memoText);
					MainActivity.getAllmemos();
	...
	private void selectLanguage(View v) {
		PopupMenu popup = new PopupMenu(KeyboardActivity.this, v);
				...
				runnable = new Runnable() {
					public void run() {
						...
						if (alertstate == false) {
							...
							_alerthide
									.setOnCheckedChangeListener(KeyboardActivity.this);
							myDialog.show();
	...
	protected void CallDefaultKeyBoard() {
		final Dialog def_kbdialog = new Dialog(KeyboardActivity.this);
